...
\subsection{Optimization tricks}
	...
	\subsubsection{Bit hacks}
		...
		\end{itemize}
	\subsubsection{Pragmas for bitset (put before bits/stdc++.h)}
		\begin{itemize}
			\item \lstinline{#pragma GCC optimize("O3,unroll-loops")}
			\item \lstinline{#include <bits/allocator.h>}
			\item \lstinline{#pragma GCC target("avx2,bmi,bmi2,popcnt,lzcnt")}
		\end{itemize}
	...
	% \kactlimport{SIMD.h}
	\kactlimport{UniformRandom.h}
	\kactlimport[-l sh]{StressTest.sh}
	\kactlimport{ExpressionTree.h}